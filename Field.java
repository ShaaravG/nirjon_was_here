...
public class Field {
     ...
     */
    public void place(Organism animal, int row, int col) {
     ...
     */
    public void place(Organism animal, Location location) {
     ...
     */
    public List<Organism> getLivingNeighbours(Location location) {

      assert location != null : "Null location passed to adjacentLocations";
      List<Organism> neighbours = new LinkedList<>();

      if (location != null) {
        List<Location> adjLocations = adjacentLocations(location);

        for (Location loc : adjLocations) {
          Organism animal = field[loc.getRow()][loc.getCol()];
          if (animal.isAlive())
